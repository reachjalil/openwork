...
export function DesktopPoliciesSection() {
  ...
  return (
    <section
      ...
      className="rounded-[32px] border border-gray-200 bg-gray-50/60 p-4 sm:p-6"
      data-testid="desktop-policies-section"
    >
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <h2 id="desktop-policies-section-heading" className="text-[18px] font-semibold tracking-[-0.01em] text-gray-950">
          Desktop policies
        </h2>
        {canManage ? (

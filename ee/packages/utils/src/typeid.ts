...
export const idTypesMapNameToPrefix = {
  ...
  workerBundle: "wkb",
  scheduledTask: "skt",
  scheduledTaskRevision: "skv",
  scheduledTaskGrant: "skg",
  scheduledTaskRun: "skn",
  scheduledTaskAttempt: "ska",
  scheduledTaskEvent: "ske",
  scheduledTaskArtifact: "skf",
  scheduledTaskTick: "sktk",
  auditEvent: "aev",
  telemetryEvent: "tev",
